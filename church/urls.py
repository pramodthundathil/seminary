...
urlpatterns = [
    ...
    path('user-dashboard/class-recordings/', views.church_user_recordings, name='church_user_class_recordings'),
    path('user-dashboard/payment-input/', views.church_user_payment_input, name='church_user_payment_input'),
